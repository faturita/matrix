...
//
    ...
    cout << " Test Matrix " << std::endl;
    cout << M << std::endl;
    cout << " Test Right Hand Side " << std::endl;
    cout << B << std::endl;
//
...
//
    ...
    cout << "Residual with standard Gaussian elimination " << std::endl;
    cout << M*X - B << std::endl;
...
//
    ...
    cout << "Residual with Gaussian elimination and pivoting " << std::endl;
    cout << M*X - B << std::endl;


    cout << M/B - X << std::endl;

    cout << M*(M/B) - B << std::endl;
