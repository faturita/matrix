...
//*****************************************************************
//
std::ostream&  operator <<(std::ostream& out_stream, const CAMstructureBase& A)
{
    int i;
...
{
    std::cerr << "Argument to Dimension Selection Out of Bounds " << '\n';
    std::cerr << "Argument Input : " << i << " Acceptable Range : " <<
