...
//********************************************************************************
//
std::ostream&  operator <<(std::ostream& out_stream, const MVAlongBase& A)
{
...
std::istream&  operator >>(std::istream& in, MVAlongBase& A)
{
...
//********************************************************************************
//
void MVAlongBase::inputLong(std::istream& in, MVAlongBase& A)
{
//
...
{
    std::cerr << "MVAlongBase Array of Insufficient Size For >> Operation"
         << std::endl  << "Array    Size : " << ArraySize
         << std::endl  << "Required Size : " << RequiredSize << std::endl;
         exit(1);
}
void   MVAlongBase::indexError(long Index)
{
    std::cerr << "Index out of range in MVAlongBase.\n";
    std::cerr << "Offending Index Value = " << Index << std::endl;
    exit(1);
};
void   MVAlongBase::sizeError(long Lsize, long Rsize)
{
    std::cerr << "Error : Assignment of unequal sized MVAlongBase \n";
    std::cerr << "Left Operand : " << Lsize   << std::endl;
    std::cerr << "Rght Operand : " << Rsize << std::endl;
    exit(1);
};
void   MVAlongBase::reSizeError(long size)
{
    std::cerr << "Error : invalid size for resizing of MVAlongBase \n";
    std::cerr << "Offending Size  : " << size   << std::endl;
    exit(1);
};
//
//********************************************************************************
