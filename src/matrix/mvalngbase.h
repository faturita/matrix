...
//  Output 
//
    __IMPEXP__ friend std::ostream& operator <<(std::ostream& out_stream, const MVAlongBase& A);
//
//  Input
//
    __IMPEXP__ friend std::istream&  operator >>(std::istream& in_stream, MVAlongBase& A);
//
//  Assignment 
//
...
//  Input Utility
//
    static void  inputLong(std::istream& in, MVAlongBase& A);
//
//  Memory Allocation
//
