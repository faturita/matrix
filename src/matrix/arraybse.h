...
//  Output 
//
    __IMPEXP__ friend std::ostream& operator <<(std::ostream& out_stream, const CAMarrayBase& A);
//
//  Input
//
    __IMPEXP__ friend std::istream&  operator >>(std::istream& in_stream, CAMarrayBase& A);
//
