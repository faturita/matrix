...
//
  std::ofstream OutFile;                  // declare an output file stream
...
//
  ...
  if (!InFile ) 
  {std::cerr <<  " Error in Opening input File "; exit(1); }
  ...
  cout << " The matrix A " << std::endl;
  cout << A;
  cout << " The vector b " << std::endl;
  cout << b;
  cout << " The solution of A*x=b " << std::endl;
  cout << x;
  cout << " The residual " << std::endl;
  cout << residual;
