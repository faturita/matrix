...
//  Output 
//
    __IMPEXP__ friend std::ostream& operator <<(std::ostream& out_stream, const CAMmatrixBase& A);
//
//  Input
//
    __IMPEXP__ friend std::istream&  operator >>(std::istream& in_stream, CAMmatrixBase& A);
//
