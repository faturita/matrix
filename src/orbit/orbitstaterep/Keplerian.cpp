...
// Parse the TLE into three lines by finding std::endline markers ('\n')...
	...
	/*! \todo Error checking for syntactically correct TLEs, including std::endlines, carriage returns. */
