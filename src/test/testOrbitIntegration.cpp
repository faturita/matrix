...
int main()
{
    ...
    cout << "Orbit State: " << ~myOrbit.GetStateRepresentation()->GetPositionVelocity() << std::endl;
    ...
    cout << myTime.GetSeconds() << " : " << ~myOrbit.GetStateRepresentation()->GetPositionVelocity() << std::endl;
