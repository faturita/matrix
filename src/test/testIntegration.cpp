...
int main()
{
    ...
    cout << "finished propagating in " << tock() << " seconds." << std::endl;
                            
                        
                        
    cout << "RK-4(5) output: " << std::endl << std::setprecision(15) <<RK5History;
    ...
    cout << "finished propagating in " << tock() << " seconds." << std::endl;                       
    cout << "RK-4 output: " << std::endl << std::setprecision(15) << RK4History;
    cout << "RK-4 output2: " << std::endl << std::setprecision(15) << RK4History2;
