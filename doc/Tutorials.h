...
cout << myTime.GetDateTime().tm_mon << "/" << myTime.GetDateTime().tm_mday << "/" << myTime.GetDateTime().tm_year << std::endl;
cout << myTime.GetJulianDate() << std::endl;
\endcode
...
cout <<  timevec << std::endl << datavec << std::endl << sin(0.25) << " = " << chk << std::endl;
\endcode
